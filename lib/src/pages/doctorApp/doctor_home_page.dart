...
import 'package:uber_doctor_flutter/src/pages/doctorApp/doctorview_booking_detail_page.dart';
...
class _DoctorHomePageState extends State<DoctorHomePage> {
  ...
  void _navigateToBookingDetail(Booking bookingModel, int index) {
  Navigator.push(
    context,
    MaterialPageRoute(
      builder: (context) => DoctorBookingDetailPage(
